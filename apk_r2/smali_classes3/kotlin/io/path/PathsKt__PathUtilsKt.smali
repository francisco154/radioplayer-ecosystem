...
.method private static final Path(Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, v0}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method private static final varargs Path(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method private static final copyTo(Ljava/nio/file/Path;Ljava/nio/file/Path;Z)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
...
.method public static final varargs createParentDirectories(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    .line 566
    invoke-static {p0}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m$1(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {v0, v2}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {v0, v1}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method public static final varargs createTempDirectory(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
...
.method public static final varargs createTempFile(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
...
.method private static final div(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 996
    invoke-static {p0, p1}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method private static final varargs synthetic fileAttributesView(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    ...
    invoke-static {}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m$2()Ljava/lang/Class;
...
.method public static final getExtension(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 47
    invoke-static {p0}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final getInvariantSeparatorsPathString(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 71
    invoke-static {p0}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;)Ljava/nio/file/FileSystem;

    move-result-object v0

    invoke-static {v0}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/FileSystem;)Ljava/lang/String;
...
.method private static final varargs isDirectory(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, p1}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method private static final isSameFileAs(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    ...
    .line 383
    invoke-static {p0, p1}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
...
.method private static final varargs notExists(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, p1}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m$2(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method private static final varargs synthetic readAttributes(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    invoke-static {p0, v0, p1}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
...
.method public static final visitFileTree(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZ)V
    ...
    .line 1077
    invoke-static {}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m()Ljava/nio/file/FileVisitOption;
    ...
    .line 1078
    :goto_0
    invoke-static {p0, p3, p2, p1}, Landroidx/print/PrintHelper$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;Ljava/util/Set;ILjava/nio/file/FileVisitor;)Ljava/nio/file/Path;
